...
do_install_append() {
  ...
  install -m 0755 ${WORKDIR}/${MACHINE}/audio_load.conf -D ${D}${sysconfdir}/modules-load.d/audio_load.conf
  else
    install -m 0755 ${WORKDIR}/${MACHINE}/audio_load.conf -D ${D}${sysconfdir}/modules/audio_load.conf
  fi
