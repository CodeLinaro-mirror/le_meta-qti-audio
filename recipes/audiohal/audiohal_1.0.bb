...
DEPENDS += "glib-2.0 tinycompress tinyalsa expat media libhardware acdbloader surround-sound-3mic qahw"
DEPENDS_append_apq8098 = " audio-qaf audio-parsers audio-qap-wrapper audio-ip-handler"
DEPENDS_append_apq8009 = " ffv qti-audio-server binder audio-utils"
