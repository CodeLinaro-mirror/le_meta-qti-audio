...
RPROVIDES_${PN} += "${@'kernel-module-voice-mhi-dlkm-${KERNEL_VERSION}'.replace('_', '-')}"
...
RPROVIDES_${PN} += "${@'kernel-module-lpass-cdc-dlkm-${KERNEL_VERSION}'.replace('_', '-')}"
RPROVIDES_${PN} += "${@'kernel-module-lpass-cdc-rx-macro-dlkm-${KERNEL_VERSION}'.replace('_', '-')}"
RPROVIDES_${PN} += "${@'kernel-module-lpass-cdc-tx-macro-dlkm-${KERNEL_VERSION}'.replace('_', '-')}"
RPROVIDES_${PN} += "${@'kernel-module-lpass-cdc-va-macro-dlkm-${KERNEL_VERSION}'.replace('_', '-')}"
RPROVIDES_${PN} += "${@'kernel-module-lpass-cdc-wsa-macro-dlkm-${KERNEL_VERSION}'.replace('_', '-')}"
RPROVIDES_${PN} += "${@'kernel-module-lpass-cdc-wsa2-macro-dlkm-${KERNEL_VERSION}'.replace('_', '-')}"
